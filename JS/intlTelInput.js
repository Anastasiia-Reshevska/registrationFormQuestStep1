      ...
      _ = class {
                  ...
                  if (t) {
                    let u = this.a.selectionStart === 0 && r.key === '+',
                      ...
                      m =
                        ...
                        p.length >= this.maxCoreNumberLength,
                      y = this.a.value.substring(
        ...
        _0() {
          ...
          if (a.utils && s) {
            let o = a.utils.numberType[e],
              r = this.s.iso2
                ? a.utils.getExampleNumber(this.s.iso2, i, o)
                : '';
            (r = this._7(r)),
        ...
        isValidNumberPrecise() {
          ...
          return /\p{L}/u.test(t)
            ? !1
            : a.utils
            ? a.utils.isValidNumber(t, this.s.iso2)
            : null;
        }
        setCountry(t) {
          let e = t?.toLowerCase(),
